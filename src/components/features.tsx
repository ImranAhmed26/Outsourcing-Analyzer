...
const Features = memo(() => {
  ...
  return (
    <section id='features' className='text-foreground relative overflow-hidden py-12 sm:py-16 md:py-20'>
      ...
      >
        <header>
          ...
          <p className='text-muted-foreground text-lg text-center max-w-2xl'>Powerful tools to streamline your workflow</p>
        </header>
        ...
        <div className='grid grid-cols-12 gap-4 justify-center'>
          ...
          >
            <div className='flex flex-col gap-4'>
              <h3 className='text-2xl leading-none font-semibold tracking-tight'>Everything At Once</h3>
              <div className='text-md text-muted-foreground flex flex-col gap-2 text-sm'>
                <p className='max-w-[460px]'>
                  Gather leads and access rich data effortlessly with AI integration across 1000+ sources, all in one streamlined
                  platform.
                </p>
              </div>
            </div>
            ...
            <div className='pointer-events-none flex grow items-center justify-center select-none relative'>
              <div className='relative w-full h-64 rounded-xl overflow-hidden' style={{ borderRadius: '20px' }}>
                <div className='absolute inset-0 flex items-center justify-center'>
                  <div className='flex items-center gap-8'>
                    <Image src='/flow.svg' alt='flow' fill className='z-10 mix-blend-screen' priority />
          ...
          >
            <div className='flex flex-col gap-4'>
              <h3 className='text-2xl leading-none font-semibold tracking-tight'>Global Market Access</h3>
              <div className='text-md text-muted-foreground flex flex-col gap-2 text-sm'>
                <p className='max-w-[460px]'>
                  Access all global markets in one window with AI-powered tools, connecting you to business opportunities and lead
                  data across every region.
                </p>
              </div>
            </div>
              ...
              <div className='absolute -right-14 z-10 flex items-center justify-center'>
                <div className='w-[400px] h-64'>
                  <Suspense fallback={<EarthFallback />}>
                    <Earth glowColor={[0.906, 0.541, 0.325]} baseColor={[0.906, 0.541, 0.325]} dark={1} />
                  </Suspense>
                </div>
              </div>
