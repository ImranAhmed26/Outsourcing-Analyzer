      ...
      >
        <header className="text-center space-y-4">
          ...
          <p className="text-muted-foreground text-lg text-center max-w-2xl mx-auto">
            Transform prospects into qualified leads with our intelligent 3-step
            validation process
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
          ...
          >
            <div className="z-10 space-y-4">
              ...
              <div>
                <p className="text-primary/80 text-sm font-medium uppercase tracking-wider mb-2">
                  Step 1
                </p>
                ...
                <p className="text-neutral-300 text-base leading-relaxed">
                  Describe your ideal customer profile using natural language.
                  Our AI understands complex criteria and filters across
          ...
          >
            <div className="z-10 space-y-4">
              ...
              <div>
                ...
                <p className="text-neutral-300 text-base leading-relaxed">
                  Advanced algorithms scan 1000+ data sources, verify contact
                  information, assess engagement likelihood, and score each
                  prospect&apos;s conversion probability in real-time.
                </p>
              </div>
            </div>
          ...
          >
            <div className="z-10 space-y-4">
              ...
              <div>
                ...
                <p className="text-neutral-300 text-base leading-relaxed">
                  Get a curated list of verified prospects with complete contact
                  details, behavioral insights, and personalized outreach
                  recommendations to maximize your conversion rates.
                </p>
              </div>
            </div>
