...
exports.getDemoNewsData = getDemoNewsData;
exports.getDemoJobPostings = getDemoJobPostings;
exports.getDemoKeyPeople = getDemoKeyPeople;
exports.fetchDemoEnhancedData = fetchDemoEnhancedData;
/**
 * Demo data for testing enhanced features without requiring API keys
 */
function getDemoNewsData(companyName) {
    const demoNews = {
        Apple: [
            {
...
function getDemoJobPostings(companyName) {
    const demoJobs = {
        Apple: [
            {
...
function getDemoKeyPeople(companyName) {
    const demoPeople = {
        Apple: [
            {
                name: 'Tim Cook',
 ...
 */
async function fetchDemoEnhancedData(companyName, basicData) {
    // Simulate API delay
