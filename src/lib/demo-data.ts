  ...
  const demoPeople: Record<string, KeyPerson[]> = {
    Apple: [
      ...
      },
      {
        ...
        predictedEmail: 'lmaestri@apple.com',
        seniority: 'C-Level',
        department: 'Finance',
      },
      {
        ...
        predictedEmail: 'jwilliams@apple.com',
        seniority: 'C-Level',
        department: 'Operations',
      },
    ],
    Microsoft: [
      {
        name: 'Satya Nadella',
        title: 'Chief Executive Officer',
        predictedEmail: 'satyan@microsoft.com',
        seniority: 'C-Level',
        department: 'Executive',
      },
      {
        name: 'Amy Hood',
        title: 'Chief Financial Officer',
        predictedEmail: 'amyhood@microsoft.com',
        seniority: 'C-Level',
        department: 'Finance',
      },
    ],
  ...
  return (
    demoPeople[companyName] || [
      ...
      },
      {
        name: 'Sarah Johnson',
        title: 'Chief Operating Officer',
        predictedEmail: `s.johnson@${domain}`,
        seniority: 'C-Level',
        department: 'Operations',
      },
    ]
